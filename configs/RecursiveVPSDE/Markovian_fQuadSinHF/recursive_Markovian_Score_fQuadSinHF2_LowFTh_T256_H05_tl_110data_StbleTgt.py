...
def get_config():
    ...
    # Model filepath
    mlpFileName = project_config.ROOT_DIR + "src/generative_modelling/trained_models/trained_rec_ST_{:.3f}FTh_MLP_{}LFac_{}{}fQuadSinHF_VPSDE_T{}_Ndiff{}_Tdiff{:.3e}_DiffEmbSz{}_ResLay{}_ResChan{}_DiffHdnSz{}_{}Hybd_{}Wghts_t0{:g}_dT{:.3e}_{}a_{}b_{}c_MLP_H{}_CUp{}_tl{}".format(
    ...
    config.nadaraya_resource_logging_path = config.scoreNet_trained_path.replace("trained_models/", "resource_logging/") + ".json".replace("trained_rec_ST_{:.3f}FTh_MLP_{}LFac_", "").replace("_Ndiff{}_Tdiff{:.3e}_DiffEmbSz{}_ResLay{}_ResChan{}_DiffHdnSz{}_{}Hybd_{}Wghts_", "_").replace("_MLP_H{}_CUp{}", "") + ".json"
