...
def get_config():
    ...
    config.data_path = project_config.ROOT_DIR + "data/fBiPot_{}DDims_samples_t0{:g}_dT{:.3e}_T{}_{}a_{}b_{}c_{}Diff_{}Init".format(
        ...
        ".", "") + ".npy"
    config.upperlims = [4.009, 3.726 ,3.527, 3.366 ,3.233 ,3.123, 3.038, 2.942 ,2.88 , 2.813 ,2.76 , 2.709]
    config.lowerlims = [-4.009, -3.742, -3.516, -3.378, -3.233, -3.128, -3.039, -2.952, -2.886, -2.823, -2.766, -2.716]
