...
def get_config():
    ...
    # Model filepath
    mlpFileName = project_config.ROOT_DIR + "src/generative_modelling/trained_models/trained_rec_ST_{:.3f}FTh_PM_LSTM_{}LFac_{}{}_fBiPot_VPSDE_T{}_Ndiff{}_Tdiff{:.3e}_DiffEmbSz{}_ResLay{}_ResChan{}_DiffHdnSz{}_{}Hybd_{}Wghts_t0{:g}_dT{:.3e}_{}a_{}b_{}c_LSTM_H{}_NLay{}_tl{}".format(
    ...
    config.model_parameters = [config.max_diff_steps, config.temb_dim, config.diff_hidden_size, config.ts_dims, config.lstm_hiddendim, config.lstm_numlay, config.lstm_inputdim, config.lstm_dropout,
    ...
    config.nadaraya_resource_logging_path = config.scoreNet_trained_path.replace("trained_models/", "resource_logging/") + ".json".replace("trained_rec_PM_ST_{:.3f}FTh_LSTM_{}LFac_", "").replace("_Ndiff{}_Tdiff{:.3e}_DiffEmbSz{}_ResLay{}_ResChan{}_DiffHdnSz{}_{}Hybd_{}Wghts_", "_").replace("_LSTM_H{}_CUp{}", "") + ".json"
