...
def get_config():
    ...
    config.ndims = 40
    config.forcing_const = 0.75
    config.diffusion = 1.
    config.initState = [
        0.0, 0.118421, 0.236842, 0.355263, 0.473684, 0.592105, 0.710526, 0.828947, 0.947368, 1.065789,
        1.184211, 1.302632, 1.421053, 1.539474, 1.657895, 1.776316, 1.894737, 2.013158, 2.131579, 2.25,
        12.0,
        2.25, 2.131579, 2.013158, 1.894737, 1.776316, 1.657895, 1.539474, 1.421053, 1.302632, 1.184211,
        1.065789, 0.947368, 0.828947, 0.710526, 0.592105, 0.473684, 0.355263, 0.236842, 0.118421
    ]
    ...
    config.save_freq = 2
    config.lr = 1e-3
    config.max_epochs = [25000]
    config.ref_batch_size = 512
    config.batch_size = 256
    config.chunk_size = 512
    config.feat_thresh = 1./10.#1./10.
    config.isfBm = True
