...
def get_config():
    ...
    mlpFileName = project_config.ROOT_DIR + "src/generative_modelling/trained_models/trained_rec_ST_{:.3f}FTh_PM_LSTM_{}LFac_{}{}_fSinLog_VPSDE_T{}_Ndiff{}_Tdiff{:.3e}_DiffEmbSz{}_ResLay{}_ResChan{}_DiffHdnSz{}_{}Hybd_{}Wghts_t0{:g}_dT{:.3e}_{}b_{}c_LSTM_H{}_NLay{}_tl{}".format(
        ...
        config.log_space_scale, config.sin_space_scale, config.lstm_hiddendim, config.lstm_numlay,
