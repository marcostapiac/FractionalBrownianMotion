...
def get_config():
    ...
    config.data_path = project_config.ROOT_DIR + "data/fSBurgers_samples_t0{:g}_dT{:.3e}_T{}__{}nu_{}alph_{}NModes_{}Diff".format(
        config.t0, config.deltaT, config.ts_length,  config.nu, config.alpha, config.num_fourier_modes,
    ...
    config.ts_dims = config.num_dims
    ...
    # Model filepath
    mlpFileName = project_config.ROOT_DIR + "src/generative_modelling/trained_models/trained_rec_ST_{:.3f}FTh_PM_MLP_{}LFac_{}{}_ImagSBurgers_VPSDE_T{}_Ndiff{}_Tdiff{:.3e}_DiffEmbSz{}_ResLay{}_ResChan{}_DiffHdnSz{}_{}Hybd_{}Wghts_t0{:g}_dT{:.3e}_MLP_H{}_CUp{}_tl{}".format(
