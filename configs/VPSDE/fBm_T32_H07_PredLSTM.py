...
def get_config():
    """ Configuration file for predictive LSTM given VP SDE model on 32-dimensional Fractional Brownian Motion"""
    ...
    # LSTM parameters
    config.lookback = 10
    config.lstm_trained_path = project_config.ROOT_DIR + "src/evaluation_pipeline/trained_models/trained_predLSTM_fBm_VPSDE_model_H{:.3e}_T{}".format(
        config.hurst,
