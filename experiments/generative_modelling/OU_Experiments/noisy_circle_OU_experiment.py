...
if __name__ == "__main__":
    ...
    mlpFileName = config.ROOT_DIR + "src/generative_modelling/trained_models/trained_MLP_noisy_circle_OU_model_T{}_Ndiff{}_Tdiff{}_trainEps{:.0e}_TembDim{}_EncShapes{}".format(
        td,
        N, Tdiff, trainEps, temb_dim, enc_shapes)
    tsmFileName = config.ROOT_DIR + "src/generative_modelling/trained_models/trained_TSM_noisy_circle_OU_model_T{}_Ndiff{}_Tdiff{}_trainEps{:.0e}_DiffEmbSize{}_ResidualLayers{}_ResChan{}_DiffHiddenSize{}".format(
        td,
