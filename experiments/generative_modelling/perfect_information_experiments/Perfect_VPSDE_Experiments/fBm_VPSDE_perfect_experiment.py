...
if __name__ == "__main__":
    ...
    evaluate_fBm_performance(h=h, td=td, generated_samples=generated_samples, true_samples=true_samples, rng=rng,
                             unitInterval=True, annot=False if td > 16 else True, evalMarginals=True)
