...
from utils.plotting_functions import plot_final_diff_marginals, plot_dataset, qqplot
...
diffusion = pickle.load(open(
    config.ROOT_DIR + "src/generative_modelling/trained_models/trained_noisy_circle_OU_model_T{}_Ndiff{}_Tdiff{}_trainEps{:.0e}".format(
        td,
...
plot_final_diff_marginals(algData, bkwd_samples[0], timeDim=td)
...
plot_final_diff_marginals(prunedAlgData, prunedData, timeDim=td)
