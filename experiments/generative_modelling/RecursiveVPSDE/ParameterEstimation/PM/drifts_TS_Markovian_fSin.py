...
print(type)
save_path = (
            project_config.ROOT_DIR + f"experiments/results/TS_mkv_fSin_DriftEvalExp_{Nepoch}Nep_{config.loss_factor}LFactor_{config.mean_rev}MeanRev_{config.max_diff_steps}DiffSteps").replace(
        ".", "")
