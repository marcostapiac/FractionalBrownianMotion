...
def true_cond_mean(config, prev_path):
    return np.array([config.ts_beta*(prev_path[1]-prev_path[0]), prev_path[0]*(config.ts_rho-prev_path[2])-prev_path[1],prev_path[0]*prev_path[1]-config.ts_beta*prev_path[2]])
