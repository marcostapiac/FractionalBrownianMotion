...
def sig_path_score_feature_analysis() -> None:
    ...
    for train_epoch in [960]:  # config.max_epochs:
        ...
        true_feat_df = pd.read_parquet("/Users/marcos/GitHubRepos/FractionalBrownianMotion/experiments/results/feature_data/fBm_H07_T256_SigTrunc5_SigDim2_True_NEp{}_SFS_bad1.parquet.gzip".format(train_epoch), engine="pyarrow")
