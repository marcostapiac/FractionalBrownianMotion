...
if __name__ == "__main__":
    # Data parameters
    from configs.RecursiveVPSDE.Markovian_fBiPot.recursive_Markovian_PostMeanScore_fBiPot_T256_H05_tl_110data_StbleTgt_WRMSE import \
        get_config
    ...
    try:
        ...
        training_size += (config.ref_batch_size - (training_size % config.ref_batch_size)) % config.ref_batch_size+        print(training_size)
        print(training_size)
        try:
