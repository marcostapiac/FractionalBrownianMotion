...
if __name__ == "__main__":
    # Data parameters
    from configs.RecursiveVPSDE.Markovian_fQuadSin.recursive_Markovian_fQuadSinWithPosition_T256_H05_tl_110data import get_config
    ...
    try:
        ...
        try:
            ...
            data = generate_fQuadSin(T=config.ts_length, isUnitInterval=config.isUnitInterval, S=training_size,
