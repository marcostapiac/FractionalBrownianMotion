...
for k in range(bws.shape[0]):
    ...
    for quant_idx in tqdm(range(rmse_quantile_nums)):
        ...
        for i in (range(1, num_time_steps + 1)):
            ...
            # global_mean = IID_NW_multivar_estimator(prevPath_observations=prevPath_observations, inv_H=inv_H,
            # norm_const=norm_const, x=global_states[:, i - 1, :], path_incs=path_incs, t1=config.t1,
