...
from configs.RecursiveVPSDE.LSTM_8DLorenz.recursive_LSTM_PostMeanScore_8DLorenz_T256_H05_tl_110data import get_config
...
if __name__ == "__main__":
    ...
    for bw_idx in tqdm(30,range(bws.shape[0])):
        bw = bws[bw_idx,:]
