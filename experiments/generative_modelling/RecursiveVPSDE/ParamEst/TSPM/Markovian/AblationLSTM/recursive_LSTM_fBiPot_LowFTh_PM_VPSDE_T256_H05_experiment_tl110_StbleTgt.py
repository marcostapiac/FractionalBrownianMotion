...
if __name__ == "__main__":
    # Data parameters
    from configs.RecursiveVPSDE.Markovian_fBiPot.recursive_LSTM_PostMeanScore_fBiPot_LowFTh_T256_H05_tl_110data_StbleTgt import \
        get_config
    ...
    with ResourceLogger(
        ...
        scoreModel = ConditionalLSTMTSPostMeanScoreMatching(*config.model_parameters)
