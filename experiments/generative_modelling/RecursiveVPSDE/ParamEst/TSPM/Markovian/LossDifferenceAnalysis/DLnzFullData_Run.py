...
from configs.RecursiveVPSDE.Markovian_20DLorenz.recursive_Markovian_PostMeanScore_20DLorenz_Stable_T256_H05_tl_110data_StbleTgt_FULLDATA import \
    get_config as get_20dlnz_config
from configs.RecursiveVPSDE.Markovian_40DLorenz.recursive_Markovian_PostMeanScore_40DLorenz_Stable_T256_H05_tl_110data_StbleTgt_FULLDATA import \
    get_config as get_40dlnz_config
from configs.RecursiveVPSDE.Markovian_8DLorenz.recursive_Markovian_PostMeanScore_8DLorenz_Stable_T256_H05_tl_110data_StbleTgt_FULLDATA import \
...
for config in [lnz_40d_config, lnz_12d_config, lnz_20d_config,lnz_8d_config]:
    ...
    all_true_paths, all_score_paths, all_nad_paths, num_time_steps,true_drift, all_score_drift_ests, all_nad_drift_ests, all_score_drift_ests_true_law, all_nad_drift_ests_true_law = generate_synthetic_paths(config=config, device_id=device_id, good=good, M_tile=block_size, Nn_tile=Nn_tile, stable=stable, prevPath_observations=is_prevPath_obs, prevPath_incs=is_prevPath_incs, inv_H=inv_H, norm_const=norm_const)
    ...
    all_score_drift_ests_true_law = all_score_drift_ests_true_law.reshape((-1, num_time_steps + 1, config.ts_dims), order="C")
    all_nad_drift_ests_true_law = all_nad_drift_ests_true_law.reshape((-1, num_time_steps + 1, config.ts_dims), order="C")
