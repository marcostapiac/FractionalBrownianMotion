...
from configs.RecursiveVPSDE.Markovian_fBiPotDDims.recursive_Markovian_PostMeanScore_fBiPot8Dims_T256_H05_tl_110data_StbleTgt_FULLDATA_LOWNOISE import get_config as get_8ddims_config
from configs.RecursiveVPSDE.Markovian_fBiPotDDims.recursive_Markovian_PostMeanScore_fBiPot12Dims_T256_H05_tl_110data_StbleTgt_FULLDATA_LOWNOISE import get_config as get_12ddims_config
...
for config in [ddims_12d_config, ddims_8d_config]:
    ...
    bw = bws[28, :] if config.ndims == 8 else bws[29,:]
