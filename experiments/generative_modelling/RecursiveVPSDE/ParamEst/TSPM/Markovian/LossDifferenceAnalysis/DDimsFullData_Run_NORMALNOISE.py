...
from configs.RecursiveVPSDE.Markovian_fBiPotDDims.recursive_Markovian_PostMeanScore_fBiPot8Dims_T256_H05_tl_110data_StbleTgt_FULLDATA_NORMALNOISE import get_config as get_8ddims_config
from configs.RecursiveVPSDE.Markovian_fBiPotDDims.recursive_Markovian_PostMeanScore_fBiPot12Dims_T256_H05_tl_110data_StbleTgt_FULLDATA_NORMALNOISE import get_config as get_12ddims_config
...
for config in [ddims_12d_config, ddims_8d_config]:
    ...
    bw = bws[30, :] if config.ndims == 8 else bws[32,:]
    ...
    save_path = (
            project_config.ROOT_DIR + f"experiments/results/DDims_NewLongerDriftEvalExp_MSEs_{num_paths}NPaths_Diff01").replace(
        ".", "")
...
import pandas as pd
save_path = (project_config.ROOT_DIR + f"experiments/results/DDims_NewLongerDriftEvalExp_MSEs_{num_paths}NPaths_Diff10").replace(
            ".", "")
