...
from configs.RecursiveVPSDE.Markovian_fBiPotDDims.recursive_Markovian_PostMeanScore_fBiPot12Dims_T256_H05_tl_110data_StbleTgt import \
    get_config as get_12dDDims_config
from configs.RecursiveVPSDE.Markovian_fBiPotDDims.recursive_Markovian_PostMeanScore_fBiPot8Dims_T256_H05_tl_110data_StbleTgt import \
    get_config as get_8dDDims_config

# In[2]:


DDims_8d_config = get_8dDDims_config()
DDims_12d_config = get_12dDDims_config()
...
toSave = True
eval_tracks = {t: np.inf for t in ["8DDims", "12DDims"]}
for config in [DDims_8d_config, DDims_12d_config]:
