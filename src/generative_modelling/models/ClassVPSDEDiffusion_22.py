...
class VPSDEDiffusion_22(nn.Module):
    def __init__(self, device: torch.cuda.Device, model, numDiffSteps: int, endDiffTime: float, trainEps: float,
                 betaMax: float, betaMin: float,
