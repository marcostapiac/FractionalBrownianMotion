...
class ConditionalStbleTgtMarkovianPostMeanDiffTrainer(nn.Module):
    ...
    def _load_snapshot(self, snapshot_path: str, config) -> None:
        ...
        try:
            ...
            if "QuadSin" in config.data_path and config.sin_space_scale == 25. and self.opt.param_groups[0]["lr"] == 0.001 and config.feat_thresh == 1./500. and 490<= self.epochs_run <= 520 : self.opt.param_groups[0]["lr"]=0.0001
